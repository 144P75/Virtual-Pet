...
| :--- | :--- | :--- |:--- |
| **นางสาวพิชยา สิทธิพันธ์** | **673380596-5** |  **Debugger** | • วางแผนและนิยามสเปกต์ระบบในเอกสาร `PLAN.md`<br>• กำหนด Definition of Done (DoD)<br>• ควบคุมภาพรวมสถาปัตยกรรมและการส่งมอบงาน |
...
| **นางสาวพรีมภัทร ภาวัฒนวคุณ** | **673380594-9** | **Planner** | • ออกแบบและทำการทดสอบเคสขอบเขต (Edge Case Testing)<br>• ตรวจสอบ Exception Handling และ Input Sanitization<br>• สรุปรายงาน QA และจัดการ Pull Request (PR) บน GitHub |
